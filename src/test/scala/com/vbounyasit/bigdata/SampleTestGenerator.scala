...
import com.vbounyasit.bigdata.sample.SampleApplication
...
import com.vbounyasit.bigdata.testing.formats.DataFrameIO
...
class SampleTestGenerator extends JobsTestGenerator {
  ...
  override val dataFrameWriter: DataFrameIO.DataFrameWriter = new JsonDfWriter

  override val defaultCustomArgument: Option[SampleArgument] = Some(SampleArgument())
